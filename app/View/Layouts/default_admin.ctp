...
<?php echo $this->Html->css('/plugins/bootstrap/css/bootstrap.min.css');?>
    
<!-- CSS Implementing Plugins -->
<link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
<link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
<?php echo $this->Html->css('/plugins/jvectormap/jquery-jvectormap-1.2.2.css');?>
<?php echo $this->Html->css('/css/AdminLTE.min.css');?>
<?php echo $this->Html->css('/css/skins/_all-skins.min.css');?>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/admin" class="logo">
          ...
          <span class="logo-lg"><b>St.Mary's</b> Admin</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo $this->Gravatar->get_gravatar($authUser['email']); ?>" class="user-image" alt="User Image">
                  <span class="hidden-xs"><?php echo $authUser['firstname'] . " " . $authUser['lastname']; ?> </span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="<?php echo $this->Gravatar->get_gravatar($authUser['email']); ?>" class="img-circle" alt="User Image">
                    <p>
                      <?php echo $authUser['firstname'] . " " . $authUser['lastname']; ?> - Web Developer
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p> <?php echo $authUser['firstname'] . " " . $authUser['lastname']; ?> </p>            
