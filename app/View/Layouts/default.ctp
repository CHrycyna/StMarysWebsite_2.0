...
<body>
	                                ...
	                                <ul class="dropdown-menu">
	                                    <li class="dropdown-submenu active">
	                                        ...
	                                        <ul class="dropdown-menu">
	                                            ...
	                                            <li class="active"><a href="feature_header_v6_semi_dark_transparent.html">Header v6 Dark Transparent</a></li>
	                ...
	                <div class="row">
	                    ...
	                    <div class="col-md-3 sm-margin-bottom-40">
	                        ...
	                        <ul class="list-unstyled thumb-news">
	                            <li>
	                                <img class="radius-3x" src="img/thumb/01.jpg" alt="">
	                            ...
	                            <li>
	                                <img class="radius-3x" src="img/thumb/02.jpg" alt="">
	                                <div class="overflow-h">
    ...
    <?php echo $this->Html->script('jquery/jquery-migrate.min.js');?>
