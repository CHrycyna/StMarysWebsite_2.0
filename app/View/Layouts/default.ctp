...
<head>
    ...
    <?php echo $this->Html->css('/plugins/revolution-slider/rs-plugin/css/settings.css');?>
    <!--[if lt IE 9]><?php echo $this->Html->css('plugins/revolution-slider/settings-ie8.css');?><!--[endif]-->
    <?php echo $this->Html->css('/plugins/fancybox/source/jquery.fancybox.css'); ?>
...
<body class="header-fixed header-fixed-space">
    ...
    <?php echo $this->Html->script('/plugins/fancybox/source/jquery.fancybox.js'); ?>
	...
	<?php echo $this->Html->script('/plugins/revolution-slider/rs-plugin/js/jquery.themepunch.tools.min.js');?>
	<?php echo $this->Html->script('/plugins/revolution-slider/rs-plugin/js/jquery.themepunch.revolution.min.js');?>
